...
from demo.models import AudienceDossier, load_audiences, load_personas, _get_audiences_path
...
def save_dossier(
    ...
    """
    target = path or _get_audiences_path()
...
def record_relationship_facts(
    ...
    try:
        ...
        try:
            ...
            log.warning("shared.config not available, skipping relationship fact indexing")
            return 0
