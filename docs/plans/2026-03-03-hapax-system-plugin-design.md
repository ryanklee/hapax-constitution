...
Moved from `ai-agents/.claude/rules/axioms.md`. Contains both axiom texts and all T0 blocking implications. Loads in every session via plugin rules auto-loading.
