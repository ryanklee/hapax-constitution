...
|------|------|-------------|
| `ai-agents/.claude/hooks/axiom-scan.sh` | 12 | Plugin hooks/scripts/ |
| `ai-agents/.claude/hooks/axiom-audit.sh` | 12 | Plugin hooks/scripts/ |
| `ai-agents/.claude/hooks/axiom-commit-scan.sh` | 12 | Plugin hooks/scripts/ |
